 ...
 *   5, 5  => 25
 */
function getRectangleArea(widthSide, heightSide) {
...
function getAngleBetweenVectors(x1, y1, x2, y2) {
  ...
  const cosAngle = vectorMultiplication / (length1 * length2);
  const cosinus = Math.acos(cosAngle);
